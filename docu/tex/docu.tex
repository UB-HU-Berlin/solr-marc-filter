...
\begin{enumerate}
	\item Repository clonen %TODO: (oder letzte Version herunterladen)
...
%	\end{itemize}
	...
	\begin{itemize}
		...
		\item Updates via SCP ausführlich getestet
		\item Updates via OAI und HTTP nur im geringen Umfang getestet
	\end{itemize}
