...
\begin{itemize}
	...
	%TODO: cpan> install Bundle::CPAN
		...
		\item Apache::Solr %TODO: dazu werden wieder weitere Pakete benötigt:
							%TODO: HTML::Entities,HTML::HeadParser,Unicode::GCString,String::Print,XML::LibXML,Log::Report::Optional,String::Print,LWP::UserAgent,Log::Report,XML::LibXML::Simple
		\item Archive::Extract	% fine 
		\item Config::INI		% needs: Mixin::Linewise::Readers,Mixin::Linewise::Writers, PerlIO::utf8_strict
%		\item Data::Dumper 		% preinstalled
		\item HTTP::OAI 		% needs: HTML::HeadParser,HTML::Entities, XML::LibXML,LWP::UserAgent,XML::LibXML::SAX
		\item (JSON::Parse )	%
		\item LWP::Simple 		% needs: HTML::HeadParser,HTML::Entities
		\item LWP::UserAgent 	% needs: HTML::HeadParser,HTML::Entities
		\item MARC::Batch 		% fine
		\item MARC::Field 		% up to date
		\item MARC::File 		% up to date
		\item Net::SCP 			% fine
		\item Net::SSH 			% up to date
		\item Sys::Info 		% needs: Sys::Info::Driver::Linux, Unix::Processors
		\item Text::Unidecode 	% fine
		\item Time::Piece 		% up to date
		\item Try::Tiny 		% fine
		\item XML::Simple		% needs: XML::Parser, XML::SAX::Expat
	\end{itemize}
\end{itemize}
