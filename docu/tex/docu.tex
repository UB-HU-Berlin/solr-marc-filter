...
%		\item Data::Dumper 		% preinstalled
		...
		%nicht mehr benötigt..
		\item \sout{Net::SCP}	% fine
		\item \sout{Net::SSH}	% up to date
		%TODO: neu
		...
		\item WWW::Curl			% needs: needs libcurl4-openssl-dev
	\end{itemize}
\end{itemize}
...
%	\end{itemize}
	...
	\begin{itemize}
		...
		%\item \sout{Updates via OAI nur im geringen Umfang getestet}
