...
\begin{longtable}{| l | p{5cm} | p{5cm} | } 
	...
	\texttt{httpUrl} & http://swblod.bsz-bw.de/od/ & URL unter der die Updates ohne Zugangsbeschränkung oder weitere URL-Parameter erreicht und heruntergeladen werden können (Updates liegen in einem gepackten Format vor). \\ \hline
